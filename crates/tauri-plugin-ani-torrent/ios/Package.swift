...
let aniTorrentCoreSearchFlags = xcframeworkSearchFlags(named: "AniTorrentCore")
...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            path: "Sources",
            swiftSettings: aniTorrentCoreSearchFlags.isEmpty
                ? []
                : [.unsafeFlags(aniTorrentCoreSearchFlags)]
        )
    ]
)
