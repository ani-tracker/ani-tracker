/*
 * Derived from rustls-platform-verifier v0.7.0 and upstream PR #179.
 * Ani Tracker vendors this source to support CRL-first verification on Android.
...
import dev.ani.tracker.mobile.BuildConfig
...
internal object CertificateVerifier {
    ...
    private fun verifyCertificateChain(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            // at the end-entity depth. We prefer CRLs and do not fall back to OCSP network fetches.
            // Stapled OCSP responses are still supplied to the checker when the server provides
            // one. We allow "soft" failures, for example unavailable revocation information.
            //
